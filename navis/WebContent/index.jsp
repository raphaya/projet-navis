...
<link rel="stylesheet" type="text/css" href=<c:url value="assets/styles/div-galerie.css"/>>
...
<body>
		...
		<div class="sidebar-nav">
			<div class="navbar navbar-inverse">
				<div class="navbar-header">
					...
					<span class="visible-xs navbar-brand">NAVIS,</span>
				</div>
				<div class="navbar-collapse collapse sidebar-navbar-collapse">
					<ul class="nav navbar-nav" id="menu">
						<li class="visible-lg visible-md visible-sm navbar-btn">NAVIS,</li>
						...
						<li class="navbar-btn" id="btn-galerie"><a href=<c:url value="/galerie"/>>Galerie</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="col-lg-8 col-md-8 col-sm-7" id="corps">
		<div class="row pull">
			<div class="col-lg-12 col-md-12 col-sm-12" id="bandeau">
				<div class="btn-group center-block">
					<button class="btn btn-success" type="button" data-action="open-popin-log" data-toggle="modal" data-target="#popin" id="menu-connect">Log in</button>
					<button class="btn btn-success" type="button" data-action="open-popin-reg" data-toggle="modal" data-target="#popin" id="menu-register">Register</button>
					<button type="button" class="btn btn-warning" id="fermeChat">Afficher / Cacher le chat</button>
				</div>
			</div>
		</div>
		<div class="row">
	...
	<div class="col-lg-2 col-md-2 col-sm-3" id="lechat">
		...
		<div class="input">
			<form method="POST" id="input-room" name="form-room">
				<input class="input" type="text" id="message" name="message" placeholder="tapez votre texte ici"> <input type="submit" value="Envoyer">
			</form>
		</div>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<button type="button" class="btn btn-success" id="btn-recovery">Récupérer son mot de passe</button>
				...
				<div class="modal-body">
					...
					<form method="POST" action="assets\scripts\recupPass.php" id="form-recup" class="form-horizontal">
						<fieldset>
							...
							<input id="recuperation" type="submit" value="valider">
						</fieldset>
					</form>
				</div>
	...
	<script src="assets/scripts/lib/ajaxGalerie.js"></script>
